...
if(CREATE_CART_TOGETHER_WITH_USER == "true") CREATE_CART_TOGETHER_WITH_USER = true;
else if(CREATE_CART_TOGETHER_WITH_USER == "false") CREATE_CART_TOGETHER_WITH_USER = false;
